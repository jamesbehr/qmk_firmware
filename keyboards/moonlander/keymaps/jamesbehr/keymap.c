...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        ...
        KC_LCTL,  KC_LGUI, KC_LALT, MO(MDIA),MO(SYMB),         PB_1,              PB_2,             MO(SYMB),MO(MDIA),KC_RALT, KC_RGUI, KC_RCTL,
    ...
    [SYMB] = LAYOUT_moonlander(
        ...
        _______, _______, KC_MINS, KC_LCBR, KC_RCBR, KC_PIPE, _______,           _______, KC_DQUO, KC_7,    KC_8,    KC_9,    _______,  _______,
        _______, KC_EQL,  KC_UNDS, KC_LPRN, KC_RPRN, KC_PLUS, _______,           _______, KC_QUOT, KC_4,    KC_5,    KC_6,    KC_0,     _______,
        _______, _______, KC_BSLS, KC_LBRC, KC_RBRC, KC_TILD,                             KC_GRV,  KC_1,    KC_2,    KC_3,    _______,  _______,
